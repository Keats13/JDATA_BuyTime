...
class SBBTree():
	...
	""" author：Cookly """
	def __init__(self, params, stacking_num, bagging_num, bagging_test_size, num_boost_round, early_stopping_rounds, train_features):
		"""
	...
	def fit(self, X, y):
		...
		if self.stacking_num > 1:
			...
			for k,(train_index, test_index) in enumerate(self.SK.split(X, y)):
				...
				df = pd.DataFrame(self.train_features, columns=['feature'])
		...
		for bn in range(self.bagging_num):
			...
			print("======================")
			score_sum += gbm.best_score['valid_0'][self.params['metric']]
			self.bagging_model.append(gbm)
		print(score_sum/self.bagging_num)
